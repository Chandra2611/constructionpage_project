  ...
  <section class="service_section layout_padding">
    <div class="service_container">
      <div class="container ">
        ...
        <div class="row">
          <?php
          $sql = "SELECT * FROM `service_table` WHERE status='1'";
          $result = mysqli_query($db, $sql);
      ...
      <div class="carousel-wrap ">
        ...
        <div class="owl-carousel project_carousel">
          ...
          if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
          ?>
              <div class="item <?php echo $row['category']; ?>">
                <div class="box">
                  <div class="img-box">
                    <img src="admin/upload/<?php echo $row['img']; ?>" alt="">
        ...
        <div class="col-lg-4 col-md-5 offset-md-1">
          <div class="form_container">
            <form action="action.php" method="post">
              ...
              <div>
                <input type="tel" placeholder="Phone Number" name="phone" pattern="[0-9]{3}[0-9]{2}[0-9]{3}[0-9]{2}" id="phone" />
              </div>
              <div>
